...
while(1) {
      ...
      for( t=0;t<10;++t) { Invaders1_1.xpos=random(32,38)+t*(Invaders1_1.width+6);Invaders1_1.ypos =10;Sprite_DrawImage(Invaders1_1); }
      for( t=0;t<10;++t) { Invaders2_1.xpos=random(17,27)+t*(Invaders2_1.width+6);Invaders2_1.ypos =40;Sprite_DrawImage(Invaders2_1); }
      for( t=0;t<10;++t) { Invaders3_1.xpos=random(29,34)+t*(Invaders3_1.width+6);Invaders3_1.ypos =70;Sprite_DrawImage(Invaders3_1); }
